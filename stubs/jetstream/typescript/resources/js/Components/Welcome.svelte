...
<div>
    ...
    >
        <ApplicationLogo classes="block h-12 w-auto" />
        ...
        <p class="mt-6 leading-relaxed text-gray-500 dark:text-gray-400">
            ...
            environment that is simple, powerful, and enjoyable. We believe you should love
    ...
    >
        ...
        <div>
            ...
            <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                ...
                that doesn't get in your way. You'll be amazed how easily you can build and maintain
        ...
        <div>
            ...
            <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                ...
                free to get started with what matters most: building your application.
            </p>
        </div>
    </div>
</div>
