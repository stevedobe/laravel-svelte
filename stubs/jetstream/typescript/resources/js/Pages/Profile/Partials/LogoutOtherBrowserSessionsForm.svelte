<script lang="ts">
    ...
    let { sessions, classes = '' }: Props = $props();
...
<ActionSection {classes}>
    {#snippet actionSectionTitle()}
        <div class="contents">Browser Sessions</div>
    {/snippet}
    ...
    {#snippet actionSectionContent()}
        <div class="contents">
            ...
            <DialogModal show={confirmingLogout} closed={closeModal}>
                {#snippet dialogModalTitle()}
                    <div class="contents">Log Out Other Browser Sessions</div>
                {/snippet}
                    ...
                    <div class="contents">
                        ...
                        <div class="mt-4">
                            <TextInput
                                ...
                                entered={logoutOtherBrowserSessions}
                                dataTestId="logout-other-browser-sessions-form-password"
                            />
                ...
                {#snippet dialogModalFooter()}
                    <div class="contents">
                        ...
                        <PrimaryButton
                            ...
                            clicked={logoutOtherBrowserSessions}
                        >
                            Log Out Other Browser Sessions
                        </PrimaryButton>
                    </div>
